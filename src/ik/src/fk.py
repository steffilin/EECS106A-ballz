...
def fk_service_client():
    ...
    joint_input = [float(c) for c in input("input comma-separated lsit of 7 joint angles: ").split(", ")]

    # fk_request.pose_stamped.pose.position.x = xyz[0]
    # fk_request.pose_stamped.pose.position.y = xyz[1]
    # fk_request.pose_stamped.pose.position.z = xyz[2]
    # fk_request.pose_stamped.pose.orientation.x = 0.0
    # fk_request.pose_stamped.pose.orientation.y = 1.0
    # fk_request.pose_stamped.pose.orientation.z = 0.0
    # fk_request.pose_stamped.pose.orientation.w = 0.0
